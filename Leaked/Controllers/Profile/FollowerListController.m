...
@interface FollowerListController () <ConnectCellDelegate>
{
...
// Functions;
#pragma mark - FollowerListController
...
{
    // Get;
    [APIClient getFollowers:self.user last:0 count:DEFAULT_COUNT completion:^(NSArray *users) {
        // Users;
...
{
    // Get;
    [APIClient getFollowers:self.user last:last count:DEFAULT_COUNT completion:^(NSArray *users) {
        // Users;
